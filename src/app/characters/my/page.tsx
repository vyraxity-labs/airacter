            ...
            <section className='relative rounded-[24px] overflow-hidden bg-linear-to-r from-primary/80 to-secondary p-10 flex items-center justify-between group shadow-lg shadow-primary-container/10 border border-white/5 select-none'>
              <div className='z-10 max-w-lg'>
                ...
                <p className='text-white/80 text-sm mb-6 leading-relaxed'>
                  Our new Character Engine v2 allows for deeper emotional
                  resonance, sarcastic wit, and persistent memory across all
                  your devices.
                </p>
                <Link
                  href='/characters/new'
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6'>
                ...
                >
                  ...
                  <p className='text-xs text-outline max-w-xs mt-1'>
                    Build a custom personality with prompt instructions, name,
                    description and tone variables.
                  </p>
                </Link>
                ...
                <div className='border border-border/30 rounded-2xl p-8 flex flex-col items-center justify-center gap-3 text-center bg-surface-lowest/20 backdrop-blur-sm min-h-[220px] select-none md:col-span-1 xl:col-span-2'>
                  ...
                  <p className='text-xs text-outline max-w-xs mt-1'>
                    Try clearing your search query or check the explore tab to
                    bookmark public personas.
                  </p>
                  <Link
                    href='/explore'
