    ...
    <div className="flex-grow flex items-center justify-center p-6 relative overflow-hidden min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <div className="relative z-10 w-full max-w-[1000px] grid md:grid-cols-2 gap-12 px-4 py-8 items-center">
        ...
        {!registered && (
          <div className="hidden md:flex flex-col justify-center space-y-8 pr-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="glass-panel p-5 rounded-xl space-y-2 mt-4">
        ...
        <div className={`flex items-center justify-center w-full ${registered ? 'md:col-span-2' : ''}`}>
          ...
          {!registered ? (
            /* Registration Card */
            <div className="glass-panel p-8 md:p-10 rounded-[2rem] w-full max-w-md shadow-2xl theme-transition">
              ...
              {error && (
                <div className="mb-4 p-3 rounded-xl bg-error/15 border border-error/30 text-error text-sm flex items-start gap-2">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1">
                  ...
                  <div className="relative group">
                    ...
                    id="fullname"
                      ...
                      className="w-full bg-surface-container-low border border-outline-variant/30 rounded-xl py-3 pl-11 pr-4 text-sm text-foreground placeholder:text-on-surface-variant/40 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all theme-transition"
                      required
                      disabled={loading}
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    id="password"
                      ...
                      className="w-full bg-surface-container-low border border-outline-variant/30 rounded-xl py-3 px-4 text-sm text-foreground placeholder:text-on-surface-variant/40 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all theme-transition"
                      required
                      disabled={loading}
                    />
                  </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 rounded-xl text-white font-semibold btn-gradient flex items-center justify-center gap-2 active:scale-98 transition-all disabled:opacity-50 cursor-pointer shadow-md shadow-primary/10 mt-6"
                >
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3 border border-outline-variant/30 rounded-xl flex items-center justify-center gap-3 bg-surface-container-highest/30 hover:bg-surface-container-highest/60 transition-all font-semibold text-sm text-foreground active:scale-98 disabled:opacity-50 cursor-pointer theme-transition"
              >
            ...
            /* Success View */
            <div className="glass-panel p-8 md:p-12 rounded-[2rem] w-full max-w-md shadow-2xl text-center flex flex-col items-center space-y-6 theme-transition animate-in fade-in zoom-in duration-500">
              <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-primary to-secondary flex items-center justify-center mb-4 text-white shadow-md shadow-primary/20">
                <CheckCircle size={40} />
              </div>
