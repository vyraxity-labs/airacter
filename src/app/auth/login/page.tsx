...
function LoginContent() {
  ...
  return (
    <main className="w-full max-w-[420px] z-10 py-8">
      ...
      {/* Login Form Card */}
      <div className="glass-panel p-8 rounded-[2rem] shadow-2xl theme-transition">
        {/* Notifications */}
        {error && (
        ...
        {successMsg && (
          <div className="mb-4 p-3 rounded-xl bg-primary/15 border border-primary/30 text-primary text-sm flex items-start gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-1">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-surface-container-low border border-outline-variant/30 rounded-2xl py-3.5 pl-12 pr-4 text-sm text-foreground placeholder:text-on-surface-variant/40 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all theme-transition"
                required
                disabled={loading}
              />
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 rounded-2xl text-white font-semibold btn-gradient flex items-center justify-center gap-2 active:scale-98 transition-all disabled:opacity-50 cursor-pointer shadow-md shadow-primary/10 mt-6"
          >
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 border border-outline-variant/30 rounded-2xl flex items-center justify-center gap-3 bg-surface-container-highest/30 hover:bg-surface-container-highest/60 transition-all font-semibold text-sm text-foreground active:scale-98 disabled:opacity-50 cursor-pointer theme-transition"
        >
